...
@section('content')
    ...
    <div class="text-center title-head">
        ...
        <div class="text-right">
            <button class="text-center e-button"><a href="/document"><img class="e-icon-button" src="/img/icon-button/them.svg">Thêm mới</a>
            </button>
            <button class="text-center e-button" onclick="showFindFrame('#e-find-frame', '#e-advanced-find-frame');">
                <img class="e-icon-button"
                     src="/img/icon-button/tim_kiem_nhanh.svg">Tìm
                kiếm nhanh
            </button>
            <button class="text-center e-button" onclick="showFindFrame('#e-advanced-find-frame', '#e-find-frame')"><img
                        class="e-icon-button"
                        src="/img/icon-button/tim_kiem_nang_cao.svg">Tìm kiếm nâng cao
            </button>
        </div>

    </div>
    <div class="row" id="e-find-frame">
        <div class="text-center e-find-label">Tìm kiếm nhanh</div>
        <div class="text-center">
            <table class="e-find-table" style="margin: auto">
                <tr>
                    <td><span style="margin-left: 20px">Số đến: </span></td>
                    <td>{!! Form::text('note[]', "", array('class'=>'form-control e-field-right', 'placeholder'=>'Từ số')) !!}</td>
                    <td>{!! Form::text('note[]', "", array('class'=>'form-control', 'placeholder'=>'Đến số')) !!}</td>
                </tr>
                <tr>
                    <td><span style="margin-left: 20px">Ngày đến:</span></td>
                    <td><input id="my-time" name="time" type="text" class="form-control datepicker" required
                               value="" placeholder="Từ ngày"></td>
                    <td><input id="my-time" name="time" type="text" class="form-control datepicker" required
                               value="" placeholder="Đến ngày"></td>
                </tr>
                <tr>
                    <td><span style="margin-left: 10px">Từ khóa: </span></td>
                    <td colspan="2">{!! Form::text('note[]', "", array('class'=>'form-control', 'placeholder'=>'Nhập từ khóa tìm kiếm')) !!}</td>
                </tr>
            </table>
        </div>
        <div class="text-center e-find-label">
            <button class="text-center e-button"><img class="e-icon-button"
                                                      src="/img/icon-button/tim_kiem.svg">Tìm kiếm
            </button>
            <button class="text-center e-button" type="button"
                    onclick="hideFindFrame('#e-find-frame');"><img class="e-icon-button"
                                                                   src="/img/icon-button/dong.svg">Đóng
            </button>
        </div>
    </div>
    <div id="e-advanced-find-frame" class="row">
        <div class="text-center e-find-label">Tìm kiếm nâng cao</div>
        <div class="text-left e-advanced-find-left">
            <table class="e-find-table">
                <tr>
                    <td><span>Số đến: </span></td>
                    <td>{!! Form::text('note[]', "", array('class'=>'form-control e-field-right', 'placeholder'=>'Từ số')) !!}</td>
                    <td>{!! Form::text('note[]', "", array('class'=>'form-control', 'placeholder'=>'Đến số')) !!}</td>
                </tr>
                <tr>
                    <td><span>Cơ quan ban hành</span></td>
                    <td colspan="2">
                ...
                <tr>
                    <td><span>Phạm vi tìm kiếm</span></td>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <select class="classic">
                            <option>Chọn nguồn dữ liệu</option>
                            <option>Hoạt động</option>
                            <option>Tạm ngừng</option>
                        </select>
                    </td>
        ...
        <div class="text-right e-advanced-find-right">
            <table class="e-find-table">
                ...
                <tr>
                    <td><span>Từ khóa</span></td>
                    <td style="text-align: left">
                        <form action="#">
                            <input id="checkbox-1" class="checkbox-custom" name="checkbox-1" type="checkbox">
                            <label for="checkbox-1" class="checkbox-custom-label">Tìm chính xác</label>
                        </form>
                    </td>
                    <td>
                        <select class="classic">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <select class="classic">
                            <option value="">Nhập tên người xử lý</option>
                            <option value="">Chọn cơ quan ban hành</option>
                            <option value="">Chọn cơ quan ban hành</option>
                        </select>
                    </td>
    ...
    <div class="form-group form-inline">
        <div class="text-left">
            <div class="e-label e-blue" style="margin-right: 14px">
                <img src="/img/icon-button/sao.svg" class="e-icon-button">Số lượng văn bản chưa chuyển:<span
                        class="e-special-text"> 03 </span> văn bản
            </div>
            <div class="e-label e-blue">
                <img src="/img/icon-button/sao.svg" class="e-icon-button">Số lượng bì đến:<span
                        class="e-special-text"> 457 </span> văn bản
            </div>
        </div>
        <table id="table" class="table table-hover row-border hover order-column">
            <thead class="e-thead">
            <tr>
                <th style="width: 15px; border-top-left-radius: 3px;" class="e-border-right"></th>
                <th style="min-width: 45px" class="e-border-right">Số đến</th>
                <th style="min-width: 130px" class="e-border-right">Nơi ban hành</th>
                <th style="min-width: 70px" class="e-border-right">Số ký hiệu</th>
                <th style="width: 40px" class="e-border-right">Ngày VB</th>
                <th style="min-width: 150px" class="e-border-right">Trích yếu</th>
                <th style="min-width: 120px" class="e-border-right">Nơi nhận</th>
            ...
            <tbody>
            <tr>
                <td colspan="12">Ngày <span class="e-bold"> 01/03/2017 </span>có<span
                            class="e-bold"> 426 </span> văn bản
                </td>
            </tr>
            @for($i=0; $i<11;$i++)
                @if($i % 2 == 0)
                ...
                <tr class="row-export e-row-active-<?= $k?>" style="text-align: center">
                    ...
                    <td><input type="checkbox" style="border: #ff3e31 solid 5px"/></td>
                </tr>
            @endfor
            </tbody>
        </table>
